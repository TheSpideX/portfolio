            ...
            <div className="w-[5000px] h-[4000px] relative">
              ...
              <div className={`absolute inset-0 w-full h-full transition-all duration-1000 ${experienceStarted ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-25" style={{ zIndex: 0 }}>
                    ...
                    `}</style>
                    {/* Contact → About */}
                    <path className="path-flow" d="M 900 475 Q 1400 200 2200 450" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* About → Manifesto */}
                    <path className="path-flow" d="M 3300 450 Q 3600 200 4000 450" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Hero → About */}
                    <path className="path-flow" d="M 2350 1800 Q 2400 1100 2750 800" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Hero → Process */}
                    <path className="path-flow" d="M 1800 2150 Q 1400 2150 1050 2220" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Hero → Work */}
                    <path className="path-flow" d="M 2900 2150 Q 3300 2150 3800 2250" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Hero → Manifesto */}
                    <path className="path-flow" d="M 2900 1800 Q 3400 1000 4000 450" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Hero → TechStack */}
                    <path className="path-flow" d="M 2350 2500 Q 2300 3000 2800 3500" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                    {/* Process → TechStack */}
                    <path className="path-flow" d="M 575 2640 Q 1300 3100 2000 3500" stroke="#ccff00" strokeWidth="2" fill="none" strokeDasharray="10 10" />
                  </svg>
                  <EasterEgg />
                ...
                >
                  ...
                  <div className="absolute bottom-24 z-20 flex flex-col items-center gap-4">
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          data-cursor="EMAIL"
                          data-cursor-size="3"
                          data-cursor-svg="<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='black' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='4' width='20' height='16' rx='2'/><path d='m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7'/></svg>"
                        >
                    ...
                    <div className="flex gap-4">
                      <a href="https://github.com/TheSpideX" target="_blank" rel="noopener noreferrer" className="font-mono text-[10px] text-gray-500 hover:text-[#ccff00] transition-colors uppercase tracking-widest mix-blend-difference" data-cursor="GITHUB" data-cursor-size="3" data-cursor-svg="<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='black' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4'/><path d='M9 18c-4.51 2-5-2-7-2'/></svg>">
                        GitHub
                      </a>
                      <a href="https://www.linkedin.com/in/kumar-satyam-64a807255" target="_blank" rel="noopener noreferrer" className="font-mono text-[10px] text-gray-500 hover:text-[#ccff00] transition-colors uppercase tracking-widest mix-blend-difference" data-cursor="LINKEDIN" data-cursor-size="3" data-cursor-svg="<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='black' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z'/><rect width='4' height='12' x='2' y='9'/><circle cx='4' cy='4' r='2'/></svg>">
                        LinkedIn
                      </a>
                      <a href="https://leetcode.com/u/spideX/" target="_blank" rel="noopener noreferrer" className="font-mono text-[10px] text-gray-500 hover:text-[#ccff00] transition-colors uppercase tracking-widest mix-blend-difference" data-cursor="LEETCODE" data-cursor-size="3" data-cursor-svg="<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='black' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M10.4 2L4.2 8.2c-1.2 1.2-1.2 3.2 0 4.4l6.2 6.2c1.2 1.2 3.2 1.2 4.4 0l6.2-6.2c1.2-1.2 1.2-3.2 0-4.4L14.8 2c-1.2-1.2-3.2-1.2-4.4 0z'/><path d='M9 15l3-3 3 3'/><path d='M12 12v6'/></svg>">
                        LeetCode
                      </a>
                    </div>
                  </div>
